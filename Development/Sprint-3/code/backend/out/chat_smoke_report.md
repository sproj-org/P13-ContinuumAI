...
- Generated: 2026-02-19 01:53:11 UTC
- Mode: stub
...
| gold_sales_daily | Trend of avg_order_value by month using sales_date | chart | 1 | success |
| gold_sales_daily | What does this mart represent and what are the key KPIs? | explain | 1 | success |
...
| gold_store_sku_daily | Trend of discount_amount by month using sales_date | chart | 1 | success |
| gold_store_sku_daily | What does this mart represent and what are the key KPIs? | explain | 1 | success |
...
| gold_store_360 | Trend of active_days by month using first_date | chart | 1 | success |
| gold_store_360 | What does this mart represent and what are the key KPIs? | explain | 1 | success |
...
| gold_product_360 | Trend of active_months by month using first_tx_date | chart | 1 | success |
| gold_product_360 | What does this mart represent and what are the key KPIs? | explain | 1 | success |
...
| gold_customer_360 | Trend of avg_order_value by month using first_purchase_date | chart | 1 | success |
| gold_customer_360 | What does this mart represent and what are the key KPIs? | explain | 1 | success |
...
| gold_employee_360 | Trend of active_days by month using first_tx_date | chart | 1 | success |
| gold_employee_360 | What does this mart represent and what are the key KPIs? | explain | 1 | success |
...
| gold_inventory_health_daily | Trend of adj_avg_daily_units by month using snapshot_date | chart | 1 | success |
| gold_inventory_health_daily | What does this mart represent and what are the key KPIs? | explain | 1 | success |
