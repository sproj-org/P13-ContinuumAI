          ...
          <div className="border-t border-slate-200 p-6 bg-gradient-to-r from-slate-50 to-white">
            <div className="grid grid-cols-3 gap-3">
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 px-4 py-4 bg-gradient-to-br from-indigo-600 to-violet-600 text-white rounded-xl hover:from-indigo-700 hover:to-violet-700 transition-all shadow-md hover:shadow-lg font-medium group"
              >
